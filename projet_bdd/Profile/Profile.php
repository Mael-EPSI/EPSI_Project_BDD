...
if (!isset($_SESSION['user_id'])) {
    ...
    header("Location: ../Login_Sign/connexion.php");
    exit();
}
...
try {
    ...
    if (!$utilisateur) {
        ...
        echo '<a href="../Login_Sign/connexion.php">Login</a>';
        exit();
    }
...
<body>
    ...
    // Vérifier si la date de connexion existe
    $date_connexion = $log['date_connexion'] ?? 'Aucune connexion enregistrée';
    ?>
    <p><strong>Derniere connexion : </strong> <?php echo htmlspecialchars($date_connexion); ?></p> 
    ...
    foreach ($commandes as $commande) {
        ...
        $stmt_produits = $pdo->prepare("SELECT * FROM produit_commande WHERE commande_id = :commande_id");
