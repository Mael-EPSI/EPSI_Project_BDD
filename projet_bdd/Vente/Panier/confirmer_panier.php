...
if (!isset($_SESSION['user_id'])) {
    ...
    echo '<a href="../../Profile/index.php">Se connecter</a>'; // Lien vers la page de connexion
    exit;
}
...
if (isset($_SESSION['panier']) && count($_SESSION['panier']) > 0) {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO produits_commande (commande_id, nom, prix, description, image_path) VALUES (:commande_id, :nom, :prix, :description, :image_path)");
